    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Salonlar", x => x.GymId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Egitmenler_Salonlar_GymId",
                        column: x => x.GymId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Servisler_Egitmenler_TrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Randevular_Egitmenler_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "Egitmenler",
                        principalColumn: "TrainerId");
                    table.ForeignKey(
                        name: "FK_Randevular_Salonlar_GymId",
                        column: x => x.GymId,
                        principalTable: "Salonlar",
                        principalColumn: "GymId");
                    table.ForeignKey(
                        name: "FK_Randevular_Servisler_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Egitmenler_GymId",
                table: "Egitmenler",
                column: "GymId");

            migrationBuilder.CreateIndex(
                name: "IX_Randevular_GymId",
                table: "Randevular",
                column: "GymId");

            migrationBuilder.CreateIndex(
                name: "IX_Randevular_ServiceId",
                table: "Randevular",
                column: "ServiceId");
